 ...
 * {@link #setTextOn(CharSequence) on} text controls the text on the thumb. Similarly, the {@link #setTextAppearance(Context, int) textAppearance} and the related setTypeface() methods
 * control the typeface and style of label text, whereas the {@link #setSwitchTextAppearance(Context, int) switchTextAppearance} and the related seSwitchTypeface() methods control that
 * of the thumb. <br>
 * 
 * <p>
